...
export default function WhatsAppButton({ 
  ...
  const floatingStyles: CSSProperties = floating ? {
    position: 'fixed',
    bottom: '2rem',
    right: '2rem',
    width: '60px',
  ...
  const buttonStyles: CSSProperties = {
    ...
    alignItems: 'center',
    gap: '0.5rem',
    padding: floating ? '0' : '1rem 2rem',
    borderRadius: floating ? '50%' : '4px',
    fontWeight: 600,
    fontSize: floating ? '1.5rem' : '0.875rem',
  ...
  return (
    ...
    >
      ...
      {!floating && (children || 'Commander sur WhatsApp')}
    </a>
  );
}
